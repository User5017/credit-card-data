...
| 1 | Walking skeleton: scaffold, FRED fetcher, loader, health, render, CI, Pages | Pages URL serves the page with a green health strip and Growth/Pricing/Performance charts; Actions run green; `pytest` green; golden checks pass live | doing |
